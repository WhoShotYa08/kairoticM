...
export default function AuthorizeDrawingScreen(){
    ...
    return(
        <Container style={{flex:'1'}}>
            <div className="containerOne" style={{ marginTop: '50px' }}>
                <Form>
                    <Form.Group controlId="selectDrawing">
                    <Form.Label>Please select the drawing to authorize (*Select from uploaded documents)</Form.Label>
                    <Form.Control 
                        as="select" 
                    ...
                    >
                        ...
                        <option key={index} value={drawing}>{drawing}</option>
                        ))}
                    </Form.Control>
                    </Form.Group>

                    <Form.Group controlId="selectUser" className="mt-3">
                    <Form.Label>Please select the users to authorize (*Select from Authorized Users)</Form.Label>
                    <Form.Control 
                        as="select" 
                        value={selectedUser} 
